    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
        <div class="flex justify-between mb-6">
            <div class="inline-flex overflow-hidden rounded-lg shadow-md left-0">
                <a href="{{ route('author.categories.create') }}" 
            ...
            >
                ...
                <form action="{{ route('author.categories.index') }}" method="get">
                    <input
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 flex justify-center">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    aria-label="Edit"
                                    >
                                        <a href="{{ route('author.categories.edit', ['category' => $category]) }}">
                                            <svg
                                                class="w-5 h-5"
                                                aria-hidden="true"
                                                fill="currentColor"
                                    ...
                                    <form action="{{ route('author.categories.destroy', ['category' => $category]) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <button
                                        class="flex items-center justify-between text-sm font-medium leading-5 text-purple-600 rounded-lg focus:outline-none focus:shadow-outline-gray"
