    ...
    <div class="p-4 bg-white rounded-lg shadow-md">
        <div class="flex justify-center mb-6 md:justify-end">
            ...
            >
                ...
                <form action="{{ route('main.articles') }}" method="get">
                    <input
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4 flex justify-center">
            @forelse ($articles as $article)
                <div class="max-w-md py-4 px-8 bg-white drop-shadow-lg rounded-lg my-12 border border-indigo-500">
